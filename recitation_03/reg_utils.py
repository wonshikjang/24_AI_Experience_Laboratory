...
def plot_decision_boundary(forward_propagation, parameters, X, y):
    """
    ...
    y -- true labels, of shape (number of examples, )
    """
    ...
    # Predict the function value for the whole grid using a lambda function
    Z = np.array([
        forward_propagation(np.c_[x, y].T, parameters)[0] > 0.5 
